...
public class Arrow2 extends Projectile {
//todo add boolean to constructor to fix self damage.
    ...
    public Arrow2(Area area, Orientation orientation, DiscreteCoordinates coordinates) {
        super(area, orientation, coordinates, damagepoints, 5);
    ...
    private class ICRogueArrowInteractionHandler implements ICRogueInteractionHandler {
        ...
        public void interactWith(ICRoguePlayer player, boolean isCellInteraction) {
            if (wantsViewInteraction() && !(isConsumed())) {
                player.decreaseHp((float) damagepoints);
                consume();
            }
        }
