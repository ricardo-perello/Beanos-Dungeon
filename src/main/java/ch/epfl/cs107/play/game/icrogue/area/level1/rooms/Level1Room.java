...
public class Level1Room extends ICRogueRoom {
    public enum Level1Connectors implements ConnectorInRoom{
        ...
        Level1Connectors(DiscreteCoordinates coordinates, DiscreteCoordinates coordinates1, Orientation orientation) {
    ...
    public Level1Room(DiscreteCoordinates coordinates){
        super(Level1Connectors.getAllConnectorsPosition(), Level1Connectors.getAllConnectorsOrientation(),Level1Connectors.getAllConnectorsDestination(),
                "icrogue/Level1Room", coordinates);
    }

    public String getTitle() {
        return "icrogue/level1"+getCoordinatesString();
    }
